                ...
                <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <address className="space-y-2 text-sm not-italic">
                            <p>Tezpur, Assam</p>
                            <p>India</p>
                            <p>Phone: +91 8723912947</p>
                            <p>Email: jesmina.online@support.com</p>
                        </address>
                    </div>
                    <div className="relative">
                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <a href="https://www.instagram.com/___official_jesmina__03?igsh=aGFrczB4ZG94dzZw" target="_blank" rel="noopener noreferrer">
